                                    ...
                                    <nav
                                        ...
                                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                            <div class="profile-tabs d-flex justify-content-between flex-wrap mt-1 mt-md-0">
                                                ...
                                                <!-- edit button -->
                                                <button data-bs-toggle="modal" data-bs-target="#modal-user"
                                    ...
                                    <div class="card-datatable table-responsive pt-0">
                                        <table class="user-list-table table">
                                            ...
                                            <tbody>
                                                    ...
                                                    <div class="d-flex justify-content-left align-items-center">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <a href="" class="user_name text-truncate text-body">
                                                                <span class="fw-bolder">Iphone 13 PRO MAX</span>
                                                            </a>
                                                            <small class="emp_post text-muted">Lorem ipsum dolor sit amet
                                                ...
                                                <td>
                                                    <small class="text-nowrap">Rp 20.000.000</small>
                                                </td>
                                                {{-- <td>
                                                    <div class="btn-group">
