              ...
              <div class="sidebar-shop">
                  ...
                  <div class="card">
                      <div class="card-body">
                          ...
                          <div id="clear-filters" class="mt-4">
                              <button type="button" class="btn w-100 btn-primary">Cari</button>
                          </div>
                          <!-- Clear Filters Ends -->

                          <!-- Clear Filters Starts -->
                          <div id="clear-filters" class="mt-1">
                              <button type="button" class="btn w-100 btn-danger">Reset Filter</button>
                          </div>
                          <!-- Clear Filters Ends -->
                      </div>
                  </div>
