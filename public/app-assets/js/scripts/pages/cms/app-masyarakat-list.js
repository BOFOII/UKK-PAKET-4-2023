...
$(function () {
  ...
  if (dtUserTable.length) {
    dtUserTable.DataTable({
      ajax: '/app-assets/data/masyarakat-list.json', // JSON file to add data
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          responsivePriority: 4,
          render: function (data, type, full, meta) {
            return `<span class="text-nowrap">${full['telp']}</span>`;
          }
        },
        {
          // Actions
