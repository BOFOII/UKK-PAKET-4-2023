...
$(function () {
  ...
  if (dtUserTable.length) {
    dtUserTable.DataTable({
      ajax: '/app-assets/data/barang-list.json', // JSON file to add data
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          targets: 2,
          render: function (data, type, full, meta) {
            var $harga_awal = full['harga_awal'];

            return '<span class="text-nowrap">' + $harga_awal + '</span>';
          }
        },
        {
          targets: 3,
          render: function (data, type, full, meta) {
            var $deskripsi_barang = full['deskripsi_barang'];

            return '<span class="text-nowrap">' + $deskripsi_barang + '</span>';
          }
        },
        {
          // Actions
