...
$(function () {
  ...
  if (dtUserTable.length) {
    dtUserTable.DataTable({
      ajax: '/app-assets/data/petugas-list.json', // JSON file to add data
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          targets: 2,
          render: function (data, type, full, meta) {
            var $role = full['level']['level'];
            var roleBadgeObj = {
              petugas: feather.icons['edit-2'].toSvg({ class: 'font-medium-3 text-info me-50' }),
