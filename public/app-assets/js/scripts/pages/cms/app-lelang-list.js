...
$(function () {
  ...
  if (dtUserTable.length) {
    dtUserTable.DataTable({
      ajax: '/app-assets/data/lelang-list.json', // JSON file to add data
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          responsivePriority: 4,
          render: function (data, type, full, meta) {
            var $name = full['petugas']['nama_petugas'],
              $username = full['petugas']['username'],
              $image = full['petugas']['avatar'].url;
            if ($image) {
              // For Avatar image
              var $output =
                '<img src="' + assetPath + 'images/avatars/' + $image + '" alt="Avatar" height="32" width="32">';
        ...
        },
        {
          targets: 4,
          render: function (data, type, full, meta) {
            var $harga_awal = full['harga_akhir'];
