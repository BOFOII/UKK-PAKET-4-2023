...
$(function () {
  ...
  if (dtUserTable.length) {
    dtUserTable.DataTable({
      ajax: '/app-assets/data/tawaran-list.json', // JSON file to add data
      // columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return `<span class="text-nowrap">1</span>`;
          }
        },
        {
          ...
          responsivePriority: 4,
          render: function (data, type, full, meta) {
            var $name = full['user']['nama_lengkap'],
              $username = full['user']['username'],
              $image = full['user']['avatar']['url'];
            if ($image) {
              // For Avatar image
              var $output =
...

        {
          ...
          responsivePriority: 4,
          render: function (data, type, full, meta) {
            return `<span class="text-nowrap">${full['penawaran_harga']}</span>`;
          }
        },
        // {
        //   // Actions
